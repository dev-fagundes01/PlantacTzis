  ...
  return (
    <div className="min-h-screen bg-primaryBackground overflow-hidden">
      ...
      <div className='mx-auto mt-6 flex justify-center md:mt-8' id='home'>
        <img className='hidden w-10/12 h-[55vh] md:h-[80vh] md:block' src={DfBanner} alt="" />
        <img className='w-10/12 h-[55vh] block md:h-[80vh] md:hidden' src={DfMobileBanner} alt="" />
      </div>
      ...
      <div className='w-8/12 mx-auto my-6 flex flex-col items-center md:my-16' id='about'>
      ...
      <footer className="w-full py-8 bg-thirdBackground text-secondaryForeground" id='contact'>
        <div className="container mx-auto flex gap-1 justify-between text-center">
          <p className='p-c-secondary'>Todos os Direitos Reservados &copy; {new Date().getFullYear()} DF-Plantas</p>
